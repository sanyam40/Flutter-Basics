...
import 'package:firebaseapp/utlis/toast.dart';
import 'package:flutter/material.dart';
import 'package:firebaseapp/model/user.dart';
import 'package:firebaseapp/provider/user_notifier.dart';
import 'package:firebaseapp/screens/UserlistScreen.dart';
import 'package:provider/provider.dart';
import 'package:firebaseapp/Bloc/eligibility_bloc.dart';
import 'package:firebaseapp/services/userservices.dart';
...
Future<int> _doLogin() async {
  String username = sellerCtrl.text;
  String password = passwordCtrl.text;
  User seller =
      User.takeInput(username: username, password: password, age: age);
